...
namespace MVCReviewSite.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,CategoryID,Title,Rating,ReviewerName,PublishDate,Content")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,CategoryID,Title,Rating,ReviewerName,PublishDate,Content")] Review review)
        {
            if (ModelState.IsValid)
            {
